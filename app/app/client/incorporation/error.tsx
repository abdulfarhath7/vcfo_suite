...
export default function ClientIncorporationError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('[client/incorporation] render error:', error.message, error.digest, error.stack);
  }, [error]);
