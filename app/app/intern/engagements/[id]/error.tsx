...
export default function InternEngagementError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('[intern/engagements/[id]] render error:', error.message, error.digest, error.stack);
  }, [error]);
