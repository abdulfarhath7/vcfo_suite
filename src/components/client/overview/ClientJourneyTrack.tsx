...
/**
 * The milestone track, as a body fragment rather than its own card.
 *
 * It shows the same journey the phase bars summarise, so it now lives *inside*
 * the progress card as its expanded state — two cards for one dataset was the
 * redundancy this pass removed. Read-only: the interactive gated flowchart
 * stays on Incorporation, and node kinds come straight from `gateActiveCatalog`.
 */
