...
import { Briefcase, Inbox, LayoutDashboard, Plus, FolderClosed, BarChart3, Users, BookOpen, ClipboardCheck, History, CalendarCheck, Mail, Megaphone, Archive, Bell } from "lucide-react";
      ...
      <CommandList>
        ...
        {user?.role === "super_admin" && (
          <CommandGroup heading="Super admin">
            ...
            <CommandItem onSelect={() => go("/app/super/notifications")}><Bell className="w-4 h-4 mr-2" />Notification history</CommandItem>
          </CommandGroup>
        )}
        {user?.role === "admin" && (
          <CommandGroup heading="Firm admin">
            ...
            <CommandItem onSelect={() => go("/app/admin/notifications")}><Bell className="w-4 h-4 mr-2" />Notification history</CommandItem>
        ...
        {user?.role === "manager" && (
          <CommandGroup heading="Project manager">
            ...
            <CommandItem onSelect={() => go("/app/manager/notifications")}><Bell className="w-4 h-4 mr-2" />Notification history</CommandItem>
        ...
        {user?.role === "intern" && (
          <CommandGroup heading="Project Lead workbench">
            ...
            <CommandItem onSelect={() => go("/app/intern/notifications")}><Bell className="w-4 h-4 mr-2" />Notification history</CommandItem>
        ...
        {user?.role === "client" && (
          <CommandGroup heading="Client portal">
            ...
            <CommandItem onSelect={() => go("/app/client/notifications")}><Bell className="w-4 h-4 mr-2" />Notification history</CommandItem>
