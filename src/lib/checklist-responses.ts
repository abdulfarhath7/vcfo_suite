...
export const CLIENT_RESPONSE_FIELDS: Record<string, ChecklistField[]> = {
  ...
  'pre-7': expandDirectorSlotFields([
    ...
    {
      id: 'nrDirectorIdAddressDeclarationDraftUrl',
      label: 'ID & Address Declaration draft - Non-resident Director (directors holding a DIN)',
      type: 'file',
      section: 'Draft Incorporation Docs',
      filledBy: 'intern',
      accept: '.pdf,image/*',
    ...
    {
      id: 'nrDirectorDepositDeclarationDraftUrl',
      label: 'Deposit Declaration draft - Non-resident Director',
      type: 'file',
      section: 'Draft Incorporation Docs',
      filledBy: 'intern',
      accept: '.pdf,image/*',
    ...
    {
      id: 'residentDirectorIdAddressDeclarationDraftUrl',
      label: 'ID & Address Declaration draft - Resident Director (directors holding a DIN)',
      type: 'file',
      section: 'Draft Incorporation Docs',
      filledBy: 'intern',
      accept: '.pdf,image/*',
    ...
    {
      id: 'residentDirectorDepositDeclarationDraftUrl',
      label: 'Deposit Declaration draft - Resident Director',
      type: 'file',
      section: 'Draft Incorporation Docs',
      filledBy: 'intern',
      accept: '.pdf,image/*',
  ...
  'pre-8': expandDirectorSlotFields([
    ...
    {
      id: 'nrDirectorIdAddressDeclarationSignedUrl',
      label: 'ID & Address Declaration - Non-resident Director (if applicable)',
      type: 'file',
      section: 'Signed Documents',
      accept: '.pdf,image/*',
    },
    {
      id: 'nrDirectorDepositDeclarationSignedUrl',
      label: 'Deposit Declaration - Non-resident Director (if applicable)',
      type: 'file',
      section: 'Signed Documents',
      accept: '.pdf,image/*',
    },
    {
      id: 'residentDirectorIdAddressDeclarationSignedUrl',
      label: 'ID & Address Declaration - Resident Director (if applicable)',
      type: 'file',
      section: 'Signed Documents',
      accept: '.pdf,image/*',
    },
    {
      id: 'residentDirectorDepositDeclarationSignedUrl',
      label: 'Deposit Declaration - Resident Director (if applicable)',
      type: 'file',
      section: 'Signed Documents',
      accept: '.pdf,image/*',
    },
