...
export const CLIENT_RESPONSE_FIELDS: Record<string, ChecklistField[]> = {
  'pre-1': [
    {
      ...
      label: 'Name',
      type: 'text',
      section: 'Details of Foreign Entity/ Parent Entity',
      required: true,
    },
    {
    ...
    },
    {
      ...
      type: 'file',
      section: 'Proof of Foreign Entity / Parent Entity',
      accept: '.pdf,image/*',
      required: true,
    },
    {
      ...
      label: 'First name',
      type: 'text',
      section: 'Authorized Signatory Details',
      required: true,
    },
    {
    ...
    },
    {
      ...
      label: 'Passport',
      type: 'file',
      section: 'KYC Documents of Authorized Signatory',
      accept: '.pdf,image/*',
      required: true,
    },
    {
  ...
  'pre-2': [
    {
      ...
      type: 'date',
      section: 'Board resolution workflow',
      filledBy: 'intern',
    },
    {
  ...
  'pre-3': [
    {
      ...
      type: 'file',
      section: 'Signed board resolution upload',
  ...
  'pre-7': [
    ...
    },
    {
      ...
      type: 'file',
      section: 'Draft incorporation documents shared with client',
      filledBy: 'intern',
      accept: '.pdf,image/*',
      required: true,
    },
  ...
  'pre-8': [
    {
      ...
      type: 'file',
      section: 'Director and foreign entity signed documents',
      accept: '.pdf,image/*',
      required: true,
    },
    {
  ...
  'pre-9': [
    {
      ...
      type: 'textarea',
      section: 'Spice Part B confirmation',
  ...
  'pre-11': [
    {
      ...
      type: 'textarea',
      section: 'MCA remarks and resubmission',
      filledBy: 'intern',
      required: true,
    },
    {
  ...
  'post-8': [
    {
      ...
      type: 'date',
      section: 'Nominee Shareholder Filing',
      required: true,
    },
    {
      id: 'mgt4Srn',
  ...
  'reg-1': [
    ...
    },
    {
      ...
      label: 'Digital Signature Certificate (DSC) / E-Sign activation notes',
      type: 'textarea',
      section: 'Digital Signature Certificate (DSC) / E-Sign',
  ...
  'reg-2': [
    {
      ...
      label: 'Permanent Account Number (PAN)',
      type: 'text',
      section: 'Permanent Account Number (PAN) and Tax Deduction and Collection Account Number (TAN)',
  ...
  'reg-4': [
    ...
    },
    {
      ...
      type: 'date',
      section: 'Letter of Undertaking (LUT)',
    },
    {
      id: 'lutArn',
  ...
  'reg-6': [
    {
      ...
      label: 'LEI Number',
      type: 'text',
      section: 'Legal Entity Identifier',
  ...
  switch (item.id) {
    ...
    case 'pre-3':
      summary = r.signedBoardResolutionUrl?.trim()
        ? 'Signed board resolution uploaded'
        : null;
      break;
    case 'pre-4':
