...
export default function InviteAccept() {
  ...
  if (!inv || !eng) {
    return (
      <div className="min-h-screen grid place-items-center bg-orange-50/40 p-6" data-role="client">
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[1fr_1.05fr] bg-orange-50/40" data-role="client">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-orange-700 to-orange-800 text-white p-12 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <Eyebrow className="mt-0.5 text-orange-100">Client portal</Eyebrow>
          </div>
        </div>
        ...
        >
          <Eyebrow className="mb-4 text-orange-100">You&apos;re invited</Eyebrow>
          <h1 className="display-lg text-white">
            Join <em className="italic text-orange-200">{eng.companyName}</em>
          </h1>
        ...
        <div className="relative z-10 flex items-center gap-4 text-[11px] text-orange-100/70">
          <Mono>Document vault</Mono>
          <span className="h-1 w-1 rounded-full bg-orange-300/50" />
      ...
      <div className="relative flex items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          <div className="mb-6 flex items-start gap-2.5 rounded-lg border border-orange-200 bg-orange-50/80 p-3">
